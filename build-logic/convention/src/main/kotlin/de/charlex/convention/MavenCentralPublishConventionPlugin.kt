        ...
        with(target) {
            ...
            extensions.configure<PublishingExtension> {
                publications.withType<MavenPublication> {
                    pom {
                        ...
                        url.set("https://github.com/ch4rl3x/settings-multiplatform")
                        licenses {
                            license {
                            ...
                            scm {
                                connection.set("scm:git:github.com/ch4rl3x/settings-multiplatform.git")
                                developerConnection.set("scm:git:ssh://github.com/ch4rl3x/settings-multiplatform.git")
                                url.set("https://github.com/ch4rl3x/settings-multiplatform/tree/main")
                            }
                        }
                    }
                }
            ...
            extensions.configure<SigningExtension> {
                useInMemoryPgpKeys(
                    ...
                    getLocalProperty("SIGNING_PASSWORD") ?: System.getenv("SIGNING_PASSWORD"),
                )
